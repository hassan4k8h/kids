  ...
  getAvailablePlans(): SubscriptionPlan[] {
    return [
      this.getFreePlan(),
      {
        ...
        nameAr: 'الباقة المميزة الشهرية',
        description: 'Full access to all games and stories',
        descriptionAr: 'وصول كامل لجميع الألعاب والقصص',
        price: 3,
        currency: 'USD',
        duration: 'monthly',
        durationMonths: 1,
      ...
      },
      {
        id: 'annual',
        name: 'Annual Premium',
        nameAr: 'الباقة المميزة السنوية',
        description: 'Full access with 2 months free',
        descriptionAr: 'وصول كامل مع شهرين مجاناً',
        price: 30,
        currency: 'USD',
        duration: 'yearly',
        durationMonths: 12,
    ...
    try {
      ...
      try {
        ...
        if (userData?.email && userData?.name) {
          console.log('📧 Sending subscription notification email to:', userData.email);
          
          const message = planId === 'free' 
            ? `تم تفعيل الباقة المجانية بنجاح! يمكن لأطفالك الآن الاستمتاع بالألعاب التعليمية الأساسية.`
            : `تم ترقية اشتراكك إلى ${newPlan.nameAr} بنجاح! 🎉\n\nالآن يمكن لأطفالك الاستمتاع بـ:\n• جميع الألعاب التعليمية\n• القصص التفاعلية\n• متابعة التقدم المتقدمة\n• محتوى بدون إعلانات\n\nشكراً لك لاختيار سكيلو لتعليم أطفالك!`;
        ...
        // لا نفشل الترقية إذا فشل إرسال البريد
      }

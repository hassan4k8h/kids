...
export const STORY_CHARACTERS: StoryCharacter[] = [
  // أبطال خارقون (مجاني)
  {
    ...
    nameAr: 'سوبرمان',
    type: 'superhero',
    image: 'https://images.unsplash.com/photo-1618077360395-f3068be8e001?w=400&h=400&fit=crop&crop=center&q=80',
  ...
  },
  {
    ...
    nameAr: 'سبايدر مان',
    type: 'superhero',
    image: 'https://images.unsplash.com/photo-1531259736756-6caccf485f81?w=400&h=400&fit=crop&crop=center&q=80',
  ...
  // أبطال خارقون (مدفوع)
  {
    ...
    nameAr: 'باتمان',
    type: 'superhero',
    image: 'https://images.unsplash.com/photo-1509347528160-9329dfb4f83b?w=400&h=400&fit=crop&crop=center&q=80',
  ...
  },
  {
    ...
    type: 'superhero',
    image: 'https://images.unsplash.com/photo-1594736797933-d0dce9511d93?w=400&h=400&fit=crop&crop=center&q=80',
  ...
  // شخصيات مغامرات (مجاني)
  {
    ...
    nameAr: 'سندباد',
    type: 'adventure',
    image: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=400&h=400&fit=crop&crop=center&q=80',
  ...
  },
  {
    ...
    type: 'space',
    image: 'https://images.unsplash.com/photo-1446776653964-20c1d3a81b06?w=400&h=400&fit=crop&crop=center&q=80',
  ...
  // شخصيات الحيوانات (مجاني)
  {
    ...
    nameAr: 'ملك الغابة',
    type: 'animal',
    image: 'https://images.unsplash.com/photo-1552410260-0fd9b577afe6?w=400&h=400&fit=crop&crop=center&q=80',
...
// قوالب القصص المجانية مع صور مناسبة ومخصصة
    ...
    content: [
      {
        ...
        textAr: 'في مدينة متروبوليس المزدحمة، كان البطل الصغير {childName} يلعب في الحديقة عندما بدأت الأرض تهتز بعنف فجأة. بدأت المباني ترتجف، وركض الناس في حالة ذعر. في الأعلى في السماء، سمع سوبرمان الضجيج وطار للأسفل ليحقق. "مرحباً أيها البطل الشجاع {childName}!" قال سوبرمان بابتسامة دافئة. "يمكنني استخدام مساعد اليوم. هل تريد الانضمام إلي في مهمة مهمة جداً لإنقاذ مدينتنا؟" نظر {childName} إلى البطل الخارق القوي بحماس وأومأ بشغف. رفع سوبرمان {childName} بلطف في ذراعيه القويتين، وسوياً حلقوا في السماء الزرقاء الساطعة، مستعدين لمواجهة أي خطر ينتظرهم.',
        image: 'https://images.unsplash.com/photo-1480714378408-67cf0d13bc1f?w=800&h=400&fit=crop&crop=center&q=80',
      ...
      },
      {
        ...
        textAr: 'وأثناء طيرانهم فوق المدينة، رأى {childName} شيئاً غريباً بالقرب من منطقة وسط المدينة. "انظر، سوبرمان!" أشار {childName} بحماس. "هناك روبوت ضخم يسبب كل هذه المشاكل!" كان الروبوت العملاق يعيث فساداً بالفعل، يرفع السيارات ويلقيها حوله كالألعاب. أومأ سوبرمان بفخر لملاحظة {childName} الحادة. "ملاحظة ممتازة، {childName}! لديك عيون البطل الحقيقي. الآن، أحتاج منك أن تساعدني في التفكير في خطة. يبدو أن الروبوت يعمل بطاقة من كريستال متوهج على صدره. إذا استطعنا إزالة ذلك الكريستال، فقد نتمكن من إيقافه. لكن يجب أن نكون حذرين جداً ونعمل معاً." فكر {childName} بجد، يشعر بثقل المسؤولية ولكن أيضاً بالحماس لكونه موثوقاً في مهمة مهمة كهذه.',
        image: 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=800&h=400&fit=crop&crop=center&q=80',
      ...
      },
      {
        ...
        textAr: 'وضع سوبرمان {childName} بعناية على سطح آمن قريب. "لدي فكرة، سوبرمان!" صرخ {childName}. "ماذا لو شتت انتباه الروبوت بينما تطير خلفه؟ يمكنني أن ألوح وأصرخ لجذب انتباهه!" أضاءت عيون سوبرمان بالإعجاب. "هذا تفكير رائع، {childName}! أنت بطل حقيقي. لكن تذكر، ابق على هذا السطح الآمن وسأحميك مهما حدث." بقلب شجاع، بدأ {childName} بالقفز والتلويح بأعلام ملونة وجدها على السطح. "مرحباً، سيد الروبوت! هنا!" أدار الروبوت العملاق عينيه الحمراوين المتوهجتين نحو {childName}، مفتوناً تماماً بعرض البطل الصغير الشجاع الخالي من الخوف. كان هذا بالضبط الإلهاء الذي احتاجه سوبرمان. بسرعة البرق، طار خلف الروبوت ووصل للكريستال.',
      ...
      },
      {
        ...
        textAr: 'بحركة سريعة واحدة، أمسك سوبرمان بالكريستال المتوهج وسحقه في يديه القويتين. فوراً، توقف الروبوت عن الحركة وانطفأ بلطف، سقط على ركبتيه بلا ضرر. كانت المدينة آمنة! طار سوبرمان عائداً إلى {childName} بأكبر ابتسامة. "فعلناها، {childName}! لقد كنت رائعاً بشكل مطلق. تفكيرك السريع وقلبك الشجاع أنقذا المدينة بأكملها اليوم." أشع {childName} بالفخر، يشعر وكأنه بطل خارق حقيقي. وأثناء طيرانهم عائدين فوق المدينة، نظر الناس إلى الأعلى وهتفوا. "شكراً لك، سوبرمان و{childName}!" نادوا. في ذلك المساء، بينما طار سوبرمان بـ{childName} إلى المنزل، قال: "تذكر، {childName}، لا تحتاج لقوى خارقة لتكون بطلاً. لديك شيء أكثر تميزاً - قلب طيب، وروح شجاعة، واستعداد لمساعدة الآخرين. هذا ما يجعل البطل الحقيقي." ابتسم {childName}، يعلم أن هذه المغامرة ستُذكر إلى الأبد.',
    ...
    content: [
      {
        ...
        image: 'https://images.unsplash.com/photo-1497486751825-1233686d5d80?w=800&h=400&fit=crop&crop=center&q=80',
        childImagePlacement: 'side',
        animation: 'slideIn',
        soundEffect: 'whoosh'
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1581833971358-2c8b550f87b3?w=800&h=400&fit=crop&crop=center&q=80',
        childImagePlacement: 'main',
        animation: 'bounce',
        soundEffect: 'pop'
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1529390079861-591de354faf5?w=800&h=400&fit=crop&crop=center&q=80',
        childImagePlacement: 'hero',
        animation: 'celebration',
        soundEffect: 'celebration'
      }
    ...
    content: [
      {
        ...
        image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=400&fit=crop&crop=center&q=80',
        childImagePlacement: 'side',
        animation: 'slideIn',
        soundEffect: 'whoosh'
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1439066615861-d1af74d74000?w=800&h=400&fit=crop&crop=center&q=80',
        childImagePlacement: 'main',
        animation: 'bounce',
        soundEffect: 'whoosh'
      },
    ...
    content: [
      {
        ...
        image: 'https://images.unsplash.com/photo-1494522358652-f30e61a60313?w=800&h=400&fit=crop&crop=center&q=80',
        childImagePlacement: 'side',
        animation: 'slideIn',
        soundEffect: 'whoosh'
      },  
      {
        ...
        image: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=800&h=400&fit=crop&crop=center&q=80',
        childImagePlacement: 'main',
        animation: 'zoom',
        soundEffect: 'pop'
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1541701494587-cb58502866ab?w=800&h=400&fit=crop&crop=center&q=80',
        childImagePlacement: 'hero',
        animation: 'bounce',
        soundEffect: 'chime'
      },

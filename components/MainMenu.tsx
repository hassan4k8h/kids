        ...
        >
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="text-right rtl:text-left">
              <div className="font-ultra-bold text-blue-600 text-ultra-clear" style={{ fontSize: 'clamp(2rem, 5vw, 3rem)' }}>{Math.round(progressPercentage)}%</div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center p-4 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl border border-green-200">
              ...
              <div className="font-ultra-bold text-green-600 text-ultra-clear" style={{ fontSize: 'clamp(1.5rem, 4vw, 2rem)' }}>{completedGamesCount}</div>
            ...
            <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-sky-50 rounded-2xl border border-blue-200">
              ...
              <div className="font-ultra-bold text-blue-600 text-ultra-clear" style={{ fontSize: 'clamp(1.5rem, 4vw, 2rem)' }}>{unlockedGamesCount}</div>
            ...
            <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl border border-purple-200">
              ...
              <div className="font-ultra-bold text-purple-600 text-ultra-clear" style={{ fontSize: 'clamp(1.5rem, 4vw, 2rem)' }}>{totalGamesCount}</div>
            ...
            <div className="text-center p-4 bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl border border-orange-200">
              ...
              <div className="font-ultra-bold text-orange-600 text-ultra-clear" style={{ fontSize: 'clamp(1.5rem, 4vw, 2rem)' }}>{featuredGamesCount}</div>
